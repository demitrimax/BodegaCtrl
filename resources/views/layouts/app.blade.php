...
<head>
    ...
    <title>@yield('page-title','Sistema de Control de Inventarios')</title>
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent" color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a class="navbar-brand" href="{{ url('/') }}" rel="tooltip" title="Página de Inicio" data-placement="bottom" target="_blank">
                    Aplicativo Control de Inventario y Reportes
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="nowuikit/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <div class="dropdown">
                     ...
                     @endguest
                    <li class="nav-item">
                        <a class="nav-link" rel="tooltip" title="Siguenos en Twitter" data-placement="bottom" href="https://twitter.com/CreativeTim" target="_blank">
                            <i class="fa fa-twitter"></i>
                            <p class="d-lg-none d-xl-none">Twitter</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" rel="tooltip" title="Me gusta en Facebook" data-placement="bottom" href="https://www.facebook.com/CreativeTim" target="_blank">
                            <i class="fa fa-facebook-square"></i>
                            <p class="d-lg-none d-xl-none">Facebook</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" rel="tooltip" title="Siguenos en Instagram" data-placement="bottom" href="https://www.instagram.com/CreativeTimOfficial" target="_blank">
        ...
        <footer class="footer">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    <a href="http://www.moisesaguilarweb.com" target="_blank">Veritas Software</a>.
                </div>
            </div>
        </footer>
    </div>
